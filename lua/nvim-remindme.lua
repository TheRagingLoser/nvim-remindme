...
local function open_window()
  ...
  vim.api.nvim_buf_set_option(buf, 'filetype', 'remindme')
  ...
  api.nvim_buf_add_highlight(buf, -1, 'RemindMeHeader', 0, 0, -1)
end
...
local function update_view(direction)
  ...
  api.nvim_buf_add_highlight(buf, -1, 'RemindMeSubHeader', 1, 0, -1)
...
local function set_mappings()
  ...
  for k,v in pairs(mappings) do
    api.nvim_buf_set_keymap(buf, 'n', k, ':lua require("remindme").'..v..'<cr>', {
